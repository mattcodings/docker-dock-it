...
class RandomReview
{
    ...
    {
        add_shortcode('random-review', [$this, 'reviewShortCode']);
    }
...
//            static::$instance = new static();
    ...
    public function reviewShortCode($attributes){
        ...
        while($reviewPosts->have_posts()){
            ...
            $output = $output.'<div><a href="' . get_the_permalink() . '">' . get_the_title() . '</a>' . get_the_content() . '</div>';
        }
        return $output;
    }
}
...
//    while($reviewPosts->have_posts()){
//            $reviewPosts->the_post();
//            $output = $output.'<div class="review-in-book-post">
//            <h5 class="book-post">' .  the_title() . '</h5>
//            <p> ' . get_the_content() . '</p>
//            ' .
//
